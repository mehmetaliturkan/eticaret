        ...
        <div class="col-sm-9 padding-right">
            ...
            <div class="features_items"><!--features_items-->
                <div class="breadcrumbs">
                    <ol class="breadcrumb">
                        <li><a href="{{URL::to('/arama')}}">Arama</a></li>
                        <li class="active">{{Input::get('ara')}}</li>
                    </ol>
                </div>
                @if($en_son_urunler->count()<1)
                <span class="text text-danger">{{Input::get('ara')}} ürünü stokta bulunmamaktadır.</span>
                @endif
